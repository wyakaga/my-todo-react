...
import { Divider, Popover, PopoverContent, PopoverTrigger, Skeleton, Tooltip, useDisclosure } from "@nextui-org/react";
	...
	return (
		<div className="grid grid-cols-1 grid-rows-1 relative app-bg bg-no-repeat bg-cover bg-center min-h-screen">
			<main className="flex flex-col items-center gap-y-5 pb-5">
				<NavbarComp />
				<EditTodoForm isOpen={isOpen} onOpenChange={onOpenChange} id={Number(id)} token={token} controller={controller} data={data} />
